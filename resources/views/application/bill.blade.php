...
@section('content')
                        ...
                        <div class="row animated bill-actions-container">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="payment-actions">
                                    ...
                                    <input type="hidden" class="form-control col flex-grow-1 border-0" id="billNo" value="{{ Session::get('billNo') }}" name="billNo">
                                    ...
                                    <div class="row mx-0 mt-4 mb-2 gray-bg p-4 animated health-mpesa position-relative d-none" id="example">
                                        ...
                                        <form class="form-inline mpesa-form flex-grow-1">
                                            <div class="form-group m-0 flex-grow-1">
                                                ...
                                                <input type="hidden" class="form-control col flex-grow-1 border-0" id="customerId" value="{{  $getFoodHygieneBill->data->customerId }}" name="bId">
                                            </div>
    ...
    <script type="text/javascript">
        $(".btn-print-bill").click(function(e){
            ...
            //alert(billNo);
            window.location = '<?php echo url('print-advert-bill') ?>/'+billNo;
    ...
    <script type="text/javascript">
        $(".btn-pay").click(function(e){
            ...
            $.ajax({
                url: "<?php echo url('pay-advert-bill') ?>" ,
                type: "POST",
                    ...
                    $.ajax({
                        ...
                        success: function(data)
                        {
                            ...
                            if(data.success.success === true  && data.success.data.callback_returned === "PAID")
                            {
                                ...
                                setTimeout(function(){
                                    window.location = '<?php echo url('adverts-printables') ?>/'+pay_id;
                                }, 2000);
